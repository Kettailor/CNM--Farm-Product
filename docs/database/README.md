...
## Bổ sung cho màn hình chi tiết khu vực

Để phục vụ giao diện chi tiết khu vực của KetKat-EcoFarm, có thể bổ sung các bảng tiếng Việt không dấu theo quy ước `text_text`:

- `du_lieu.khu_vuc_chi_tiet`
- `du_lieu.nhat_ky_nong_duoc_khu_vuc`
- `du_lieu.lich_su_ghi_chu_khu_vuc`

File mẫu: `docs/database/03_khu_vuc_chi_tiet.sql`.
